	...
	public MainPanel(MainFrame mainFrame) {
		...
		addMouseListener(new MouseListener() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				if(drawRectangle)
				{
				toDraw.add(drawRectangle(startDrag.x, startDrag.y,	e.getX(), e.getY()));
				startDrag = null;
				endDrag = null;
				drawCircle = false;
				drawPen = false;
				...
				{
					toDraw.add(drawCircle(startDrag.x, startDrag.y,	e.getX(), e.getY()));
					startDrag = null;
					endDrag = null;
					drawRectangle = false;
					drawPen = false;
				...
				{
					toDraw.add(drawLine(startDrag.x, startDrag.y,	e.getX(), e.getY()));
					drawCircle = false;
					drawRectangle = false;
					drawPen = false;
					gum = false;
	...
	protected void paintComponent(Graphics graphics) {
		...
		if (drawCircle) {
			...
			new ArrayList<Shape>(toDraw).forEach(e -> {
				g2d.fill(e);
				if (startDrag != null && endDrag != null) {
					Shape r = drawRectangle(startDrag.x, startDrag.y,
							endDrag.x, endDrag.y);
					g2d.draw(r);
				}
			});
